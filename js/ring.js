...
(function(win, doc, exports) {
  var $, AmbientLight, Camera, Color, Cube, DEG_TO_RAD, DirectionalLight, Face, Face2, Line, MOUSE_DOWN, MOUSE_MOVE, MOUSE_UP, Matrix4, Object3D, PI, Particle, Plate, Renderer, Scene, Texture, Triangle, Vector3, camera, cos, init, isTouch, renderer, requestAnimFrame, rotX, rotY, scene, sin, tan, _ref;
  ...
  init = function() {
    ...
    create = function() {
      var ambLight, angle, container, dirLight, i, line, line1, line2, line3, particle, r, s, size, t, x, y, z, _i, _j, _k, _l, _loop, _ref1, _ref2;
      size = 200;
      ...
      r = 50;
      for (s = _k = 0; _k < 360; s = _k += 5) {
        for (t = _l = 0; _l < 360; t = _l += 5) {
          x = r * cos(s) * sin(t);
          y = r * sin(s) * sin(t);
          z = r * cos(t);
