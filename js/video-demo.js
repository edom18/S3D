...
(function(win, doc, exports) {
  var AmbientLight, Camera, Color, Cube, DirectionalLight, Face, Line, MOUSE_DOWN, MOUSE_MOVE, MOUSE_UP, Matrix4, Object3D, PI, Particle, Plate, Renderer, Scene, Texture, Triangle, Vector3, base, camera, cos, dragging, init, isTouch, prevX, prevY, renderer, rotX, rotY, scene, sin, startZoom, tan, _ref;
  ...
  scene = null;
  init = function() {
    var aspect, create, ctx, cv, fov, h, video, w;
    ...
    create = function() {
      var ambLight, container, dirLight, div, divH, divW, face, i, j, line, line1, line2, line3, materials2, size, uv_x1, uv_x2, uv_x3, uv_x4, uv_y1, uv_y2, uv_y3, uv_y4, videoContainer, videoHeight, videoWidth, x, z, _i, _j, _k, _l, _loop, _ref1, _ref2;
    ...
    video.autoplay = true;
    video.loop = true;
    return video.addEventListener('canplaythrough', create, false);
  };
  dragging = false;
  prevX = 0;
  prevY = 0;
