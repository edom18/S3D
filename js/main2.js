...
(function(win, doc, exports) {
  var AmbientLight, Camera, Color, Cube, DEG_TO_RAD, DirectionalLight, Face, Line, MOUSE_DOWN, MOUSE_MOVE, MOUSE_UP, Matrix4, Object3D, PI, Particle, Plate, Renderer, Scene, Texture, Triangle, Vector3, camera, cos, getVideo, init, isTouch, logoImage, photoImage, renderer, rotX, rotY, scene, sin, tan, textureImage, _ref;
  ...
  init = function() {
    var aspect, base, cnt, create, ctx, cv, dragging, fov, h, img, logo, moveX, moveY, photo, prevX, prevY, startZoom, video, w;
    video = getVideo();
