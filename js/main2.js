...
(function(win, doc, exports) {
  var Camera, Cube, DEG_TO_RAD, Face, MOUSE_DOWN, MOUSE_MOVE, MOUSE_UP, Matrix4, PI, Particle, Plate, Renderer, Scene, Texture, Triangle, Vector3, base, camera, cos, dragging, ground_1_uv, ground_2_uv, init, isTouch, prevX, prevY, renderer, roof_1_uv, roof_2_uv, rotX, rotY, scene, sin, startZoom, tan, textureImage, wall_1_uv, wall_2_uv, wall_3_uv, wall_4_uv, wall_5_uv, wall_6_uv, wall_7_uv, wall_8_uv, _ref;
  tan = Math.tan, cos = Math.cos, sin = Math.sin, PI = Math.PI;
  _ref = window.S3D, Plate = _ref.Plate, Face = _ref.Face, Cube = _ref.Cube, Texture = _ref.Texture, Triangle = _ref.Triangle, Matrix4 = _ref.Matrix4, Camera = _ref.Camera, Renderer = _ref.Renderer, Scene = _ref.Scene, Vector3 = _ref.Vector3, Particle = _ref.Particle;
  DEG_TO_RAD = PI / 180;
