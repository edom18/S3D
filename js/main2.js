...
(function(win, doc, exports) {
  ...
  init = function() {
    ...
    return create = function() {
      var cube, materials;
      materials = [new Texture(textureImage, roof_1_uv), new Texture(textureImage, roof_2_uv), new Texture(textureImage, wall_1_uv), new Texture(textureImage, wall_2_uv), new Texture(textureImage, wall_3_uv), new Texture(textureImage, wall_4_uv), new Texture(textureImage, wall_5_uv), new Texture(textureImage, wall_6_uv), new Texture(textureImage, wall_7_uv), new Texture(textureImage, wall_8_uv)];
