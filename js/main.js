...
(function(win, doc, exports) {
  var Camera, FAR, MOUSE_DOWN, MOUSE_MOVE, MOUSE_UP, Matrix4, PI, Particle, Renderer, Scene, Vector3, cHeight, cWidth, camera, cos, ctx, cv, dragging, draw, init, isTouch, particles, prevX, prevY, random, renderer, requestAnimFrame, rotX, rotY, rotZ, scene, sin, sqrt, tan, _ref;
  sqrt = Math.sqrt, sin = Math.sin, cos = Math.cos, tan = Math.tan, PI = Math.PI, random = Math.random;
  _ref = window.S3D, Matrix4 = _ref.Matrix4, Camera = _ref.Camera, Renderer = _ref.Renderer, Scene = _ref.Scene, Vector3 = _ref.Vector3, Particle = _ref.Particle;
