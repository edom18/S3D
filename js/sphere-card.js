...
(function(win, doc, exports) {
  var $, AmbientLight, Camera, Color, Cube, DEG_TO_RAD, DiffuseLight, DirectionalLight, Face, Face2, Line, MOUSE_DOWN, MOUSE_MOVE, MOUSE_UP, Matrix4, Object3D, PI, Particle, Plate, RAD_TO_DEG, Renderer, Scene, Texture, Triangle, Vector3, atan2, camera, cos, init, isTouch, random, renderer, requestAnimFrame, rotX, rotY, scene, sin, tan, _ref;
  atan2 = Math.atan2, random = Math.random, tan = Math.tan, cos = Math.cos, sin = Math.sin, PI = Math.PI;
  _ref = window.S3D, DiffuseLight = _ref.DiffuseLight, Face2 = _ref.Face2, Object3D = _ref.Object3D, Line = _ref.Line, Color = _ref.Color, AmbientLight = _ref.AmbientLight, DirectionalLight = _ref.DirectionalLight, Plate = _ref.Plate, Face = _ref.Face, Cube = _ref.Cube, Texture = _ref.Texture, Triangle = _ref.Triangle, Matrix4 = _ref.Matrix4, Camera = _ref.Camera, Renderer = _ref.Renderer, Scene = _ref.Scene, Vector3 = _ref.Vector3, Particle = _ref.Particle;
  $ = function(selector) {
  ...
  init = function() {
    ...
    create = function() {
      var ambLight, angle, container, diffLight, dirLight, dummy, i, line, line1, line2, line3, plate, r, s, size, t, x, y, z, _i, _j, _k, _l, _loop, _ref1, _ref2, _s, _t;
      size = 200;
